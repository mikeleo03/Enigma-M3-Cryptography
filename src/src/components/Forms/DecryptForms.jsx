...
// Decryption Forms Component
const DecryptionForm = ({ rot1Pos, rot1Order, rot2Pos, rot2Order, rot3Pos, rot3Order, enablePb, pbValue }) => {
    ...
    const handleSubmitForms = (event) => {
        ...
        try {
            ...
            let finalResult = enigmaMachine.decrypt(text);
                ...
                <div className="h-full mx-auto flex flex-col space-y-5">
                    <div className="h-7/12 space-y-4">
                        <div>
                            ...
                            <textarea 
                                ...
                                placeholder="Insert cipher text like ILBDA AMTAZ"
                            >
                            </textarea>
                        </div>
                        <button
                    ...
                    <div className="h-5/12 flex flex-col">
                        <div className="overflow-y-auto">
                            ...
                            {result ? 
                                (<div className="bg-primaryGray outline-none border focus:border-indigo-600 shadow-sm rounded-lg mt-1 px-4 py-2">{result.plaintext}</div>) 
                                : (<p>You haven't decrypt any cipher text.</p>)}
                        </div>
                    </div>
                </div>
            </div>
