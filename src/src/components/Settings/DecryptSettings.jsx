...
// Forms component
const DecryptSettings = ({ rot1Pos, rot1Order, rot2Pos, rot2Order, rot3Pos, rot3Order, setRot1Pos, setRot1Order, setRot2Pos, setRot2Order, setRot3Pos, setRot3Order, enablePb, setEnablePb, pbValue, setPbValue }) => {
